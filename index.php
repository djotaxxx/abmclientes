            ...
            <div class="col-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <small class="d-block mt-1">Archivos admitidos: .jpg, .jpeg, .png</small>
                    </div>
                    <div>
                    ...
                    <tbody>
                        <?php foreach($aClientes as $pos => $cliente): ?>
                            <tr>
                                ...
                                <td><img src="imagenes/sin-imagen.jpeg" class="img-thumbnail" style="width:80px"></td>
                                <?php else: ?>
                                <td><img src="imagenes/<?php echo $cliente["imagen"]; ?>" class="img-thumbnail" style="width:80px"></td>
                                <?php endif; ?>
